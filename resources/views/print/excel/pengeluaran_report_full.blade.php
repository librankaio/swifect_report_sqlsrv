        ...
        <center>
            <table id="mytable" border="1px" cellspacing="0">
                <tr>
                    ...
                    <td align="center" rowspan="2">Nomor Aju</td>
                ...
                @if (count($results) > 0)
                    ...
                    @foreach ($results as $key => $item)
                        <tr>
                            ...
                            <td class="border-2" style="mso-number-format:'@';">{{ $item->nomoraju }}</td>
                            ...
                            @if ($item->nilai_barang_usd == 0)
                                <td class="border-2">0</td>
                            @else
                                <td class="border-2">{{ number_format($item->nilai_barang_usd, 5, '.', ',') }}</td>
                            @endif
                        </tr>
                        @php
