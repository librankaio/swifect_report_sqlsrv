...
class MutasiBhnBakuExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithColumnWidths, WithColumnFormatting, WithStrictNullComparison
{
    protected $results;
    ...
    public function collection(): Collection
    {
        ...
        // Add title rows
        $data->push(['LAPORAN PERTANGGUNG JAWABAN MUTASI BAHAN BAKU', '', '', '', '', '', '', '', '', '', '', '']);
